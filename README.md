...
- **Memory** - Each chapter's summary keeps what happened, and later chapters are written with the latest summaries. Characters remember what later chapters will need (promises, plans, what's still unresolved, and what they've learned about people) and how they've changed. Every memory shows its source and can be edited, and a chapter only remembers what came before its start.
