    ...
    <template #api-config>
      ...
      <div class="form-group">
        ...
        <p class="section-description">
          Select which model to use from OpenAI. Different models have different capabilities and context windows.
        </p>
        ...
        <div v-else-if="!loadingModels" class="help-text">
          Enter your API key and click "Fetch Available Models" to see available OpenAI models.
        </div>
      </div>
...
async function fetchOpenAIModels() {
  ...
  try {
    ...
    const response = await presetsAPI.getOpenAIModels(localApiConfig.value.apiKey)
