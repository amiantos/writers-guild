    ...
    <template #api-config>
      ...
      <div class="form-group">
        ...
        <p class="section-description">
          Select which Claude model to use. Different models offer different balances of intelligence, speed, and cost.
        </p>
        ...
        <div v-else-if="!loadingModels" class="help-text">
          Enter your API key and click "Fetch Available Models" to see available Claude models.
        </div>
      </div>
...
async function fetchAnthropicModels() {
  ...
  try {
    ...
    const response = await presetsAPI.getAnthropicModels(localApiConfig.value.apiKey)
